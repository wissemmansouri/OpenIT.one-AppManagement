...
import (
	...
	interfaces "github.com/wisemmansouri/OpenIT.one-Common"
	"github.com/wissemmansouri/OpenIT.one-Common/utils/systemctl"
)

const (
	appManagementConfigDirPath  = "/etc/openit"
	appManagementConfigFilePath = "/etc/openit/app-management.conf"
	appManagementName           = "openit-app-management.service"
	appManagementNameShort      = "app-management"
)

//go:embedded ../../build/sysroot/etc/openit/app-management.conf.sample
